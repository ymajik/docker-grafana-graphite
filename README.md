...
[![Docker Automated build](https://img.shields.io/docker/automated/ymajik/grafana-graphite.svg)](https://hub.docker.com/r/ymajik/docker-grafana-graphite/builds/)
[![Build Status](https://travis-ci.org/ymajik/docker-grafana-graphite.svg?branch=master)](https://travis-ci.org/ymajik/docker-grafana-graphite)
